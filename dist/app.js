...
var require_ace = __commonJS({
  "src/js/ace.js"(exports2, module2) {
    "use strict";
    (function(global, factory) {
      typeof exports2 === "object" && typeof module2 !== "undefined" ? module2.exports = factory(require("jquery"), require("bootstrap")) : typeof define === "function" && define.amd ? define(["jquery", "bootstrap"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.AceApp = factory(global.jQuery, global.bootstrap));
    })(exports2, (function($$a, bootstrap$1) {
      "use strict";
      ...
      var Util = /* @__PURE__ */ (function() {
        ...
        _createClass(Util2, null, [{
          ...
          value: function _insert(element, _elem) {
            var _pos = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "afterend";
            if (typeof element === "string") element = document.querySelector(element);
            if (element === null) return null;
            if (Util2.isValidSelector(_elem)) {
            ...
            if (_elem === currentElemAtPos) return null;
            return _elem;
          }
        }, {
          key: "after",
          value: function after(element, _after) {
            return Util2._insert(element, _after, "afterend");
          }
        }, {
          key: "before",
          value: function before(element, _before) {
            return Util2._insert(element, _before, "beforebegin");
          }
        }, {
          key: "append",
          value: function append(element, _append) {
            return Util2._insert(element, _append, "beforeend");
          }
        }, {
          key: "prepend",
          value: function prepend(element, _prepend) {
            return Util2._insert(element, _prepend, "afterbegin");
          }
        }, {
          key: "wrap",
          value: function wrap(element, _wrap) {
            _wrap = Util2._insert(element, _wrap, "afterend");
          ...
          value: function unwrap(element) {
            var remove = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
            var parent = element.parentNode;
            Util2.after(parent, element);
            if (remove) Util2.remove(parent);
          }
        }, {
          key: "empty",
          ...
          value: function updateClass(element, className) {
            var add = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
            if (typeof element === "string") {
              document.querySelectorAll(element).forEach(function(el) {
                Util2.updateClass(el, className, add);
              });
              return;
            }
            if (!element) return;
            var _classes = className.split(/\s/);
            var _iterator = _createForOfIteratorHelper(_classes), _step;
            try {
          ...
          value: function addClass(element, className) {
            Util2.updateClass(element, className, true);
          }
        }, {
          key: "removeClass",
          value: function removeClass(element, className) {
            Util2.updateClass(element, className, false);
          }
        }, {
          key: "next",
          value: function next(element) {
            var selector = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
            if (!selector) return element.nextElementSibling;
            var _next = element;
            while ((_next = _next.nextElementSibling) && !Util2.matches(_next, selector)) {
            }
            return _next;
          }
        }, {
          ...
          value: function prev(element) {
            ...
            var _prev = element;
            while ((_prev = _prev.previousElementSibling) && !Util2.matches(_prev, selector)) {
            }
            return _prev;
          }
        }, {
          ...
          value: function getScrollbarInfo() {
            var recalc = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
            if (recalc === false && Util2._scrollbarInfo !== null) return Util2._scrollbarInfo;
            ...
            if (window.CSS) {
              scrollbar.thin = window.CSS.supports("scrollbar-width", "thin");
              if (scrollbar.thin) {
              ...
              scrollDiv.style.overflow = "overlay";
            ...
            scrollDiv.style["-ms-overflow-style"] = "-ms-autohiding-scrollbar";
            scrollbar.autohide = scrollbar.width > 0 && parseInt(scrollDiv.getBoundingClientRect().width - scrollDiv.clientWidth) === 0;
            document.body.removeChild(scrollDiv);
            Util2._scrollbarInfo = scrollbar;
            return Util2._scrollbarInfo;
          }
        }]);
        return Util2;
      })();
      Util._supportsTransitionStart = null;
      Util._scrollbarInfo = null;
      ...
      (function() {
        if (typeof window.CustomEvent !== "function") {
          var CustomEvent = function CustomEvent2(event, params) {
            params = params || {
              bubbles: false,
              cancelable: false,
              detail: null
      ...
      var getjQuery = function getjQuery2() {
        var _window = window, jQuery3 = _window.jQuery;
      ...
      var isNativeEvent = function isNativeEvent2(eventName) {
      ...
      function addHandler(element, originalTypeEvent, handler, delegationFn, oneOff) {
        ...
        var _normalizeParams = normalizeParams(originalTypeEvent, handler, delegationFn), _normalizeParams2 = _slicedToArray(_normalizeParams, 3), delegation = _normalizeParams2[0], originalHandler = _normalizeParams2[1], typeEvent = _normalizeParams2[2];
      ...
      var EventHandler = {
        ...
        off: function off(element, originalTypeEvent, handler, delegationFn) {
          ...
          var _normalizeParams3 = normalizeParams(originalTypeEvent, handler, delegationFn), _normalizeParams4 = _slicedToArray(_normalizeParams3, 3), delegation = _normalizeParams4[0], originalHandler = _normalizeParams4[1], typeEvent = _normalizeParams4[2];
      ...
      var Basic = /* @__PURE__ */ (function() {
        ...
        _createClass(Basic2, null, [{
          key: "_HandleBasics",
          value: function _HandleBasics() {
            Basic2._HandleGeneral();
            if (typeof window.jQuery === "undefined" || typeof window.bootstrap === "undefined") return;
            Basic2._handleAlerts();
            Basic2._handleDropdowns();
            Basic2._handleNavbar();
          }
        }, {
          key: "_HandleGeneral",
          ...
          */
          ...
          value: function _handleAlerts() {
            var $2 = window.jQuery;
            $2(document).on("close.bs.alert.alert-collapse", ".alert.alert-collapse", function(e) {
              e.preventDefault();
              $2(this).wrap('<div class="collapse show alert-collapse"></div>').parent().collapse("hide").one("hidden.bs.collapse.alert-collapse", function() {
                $2(this).remove();
              });
            });
          }
          ...
          value: function _handleDropdowns() {
            var $2 = window.jQuery;
            var _dismissDropdown = function _dismissDropdown2() {
              ...
              $2(toggle).dropdown("hide");
              menu.classList.remove("show");
              dropdown.classList.remove("show");
            };
            $2(document).on("click", "[data-dismiss=dropdown]", function(e) {
              e.preventDefault();
              _dismissDropdown.call(e.target);
            });
            $2(document).on("submit", ".dropdown-menu form[data-submit=dismiss]", function(e) {
              e.preventDefault();
              _dismissDropdown.call(e.target);
            });
            $2(document).on("click.dropdown-clickable", ".dropdown-clickable", function(e) {
              e.stopImmediatePropagation();
            });
            $2(document).on("shown.bs.dropdown", ".dropdown.dd-backdrop", function() {
              ...
              $2(this).one("hidden.bs.dropdown", function() {
          ...
          value: function _handleNavbar() {
            var $2 = window.jQuery;
            $2(document).on("click", ".navbar-backdrop.collapse.show", function(e) {
              if (e.target === this) $2(this).collapse("hide");
            });
            $2(document).on("submit", ".navbar-collapse.show form[data-submit=dismiss]", function(e) {
              e.preventDefault();
              $2(this).closest(".navbar-collapse").collapse("hide");
            });
            var currentOpenCollapse = null;
            $2(document).on("shown.bs.dropdown", ".navbar .dropdown", function() {
              ...
              if (previousOpenCollapse !== null) {
                $2(".navbar-collapse.show").css("transition-duration", "1ms").collapse("hide").css("transition-duration", "");
              }
            ...
            var _adjustDropdown = function _adjustDropdown2() {
            ...
            $2(document).on("transitionstart.adjust", ".navbar .dropdown-mega .dropdown-menu", function(ev) {
      ...
      var Scrollbar = /* @__PURE__ */ (function() {
        function Scrollbar2(element, config) {
        ...
        _createClass(Scrollbar2, [{
          ...
          value: function _addNativeScrolls(smooth) {
            if (this._scrollbarInfo.width === 0) this._element.classList.add("ace-scroll-mob");
            else {
          ...
          value: function getInstance(element) {
            var config = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
            ...
            element[name] = new Scrollbar2(element, config);
            return element[name];
          }
        }, {
          ...
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              if (!data) {
                data = Scrollbar2.getInstance(this, _config);
      ...
      var Sidebar = /* @__PURE__ */ (function() {
        function Sidebar2(element, config) {
          var _this = this;
        ...
        _createClass(Sidebar2, [{
          ...
          value: function toggle() {
            var btn = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
          ...
          value: function expand() {
            ...
            if (Util.isReducedMotion() || this._sidebar.classList.contains("no-transition") || this._horizontal || this._sidebar.offsetWidth === 0) this._toggleCompleted();
          ...
          value: function _updateTriggerBtns(btns) {
            var expanded = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
          ...
          value: function _toggleMobileCompleted() {
            ...
            if (shown) EventHandler.trigger(this._sidebar, Event$8.SHOWN);
            else {
          ...
          value: function _addTransitionEvent() {
            ...
            this._sidebar.addEventListener("transitionend", function(e) {
              if (e.target !== _this4._sidebar) return;
          ...
          value: function enableSwipeHide() {
            ...
            var sidebarWidth = 0;
            var touchMoveCallback = function touchMoveCallback2(ev) {
            ...
            EventHandler.on(document, "touchstart.sidebar-swipe", function(e) {
              ...
              EventHandler.on(document, "touchmove.sidebar-swipe", function(e2) {
                touchMoveCallback(e2);
              });
            });
            var touchEndHandler = function touchEndHandler2(e) {
              var touches = e.changedTouches[0] || null;
          ...
          value: function enableSubmenuToggle() {
            ...
            EventHandler.on(this._sidebar, "click", ".dropdown-toggle", function(ev) {
              ...
              var navItem = Util.closest(ev.delegateTarget, ".nav-item");
          ...
          value: function _submenuScroll(subMenu) {
            var delay = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 150;
          ...
          value: function enableSubmenuPullup() {
            ...
            if (this._pullupCallback === null) {
              this._pullupCallback = function(ev) {
                ...
                var navText = navItem.querySelector("* > .nav-link > .nav-text.fadeable");
                ...
                if (diff > 0) {
                  ...
                  var diff2 = rect.top - navTextHeight - diff - navbarHeight;
                  if (diff2 < 0) diff = diff + diff2;
                  diff = parseInt(diff) + 1;
                  if (_this8._collapsed) {
                    if (navTextHeight && diff > navTextHeight / 2 && navItem) navItem.classList.add("submenu-pullup");
                  } else {
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new Sidebar2(element, config);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              if (!data) {
                data = Sidebar2.getInstance(this, _config);
      ...
      var Aside = /* @__PURE__ */ (function() {
        function Aside2(element, config) {
          _classCallCheck(this, Aside2);
          this._config = this._getConfig(config);
        ...
        _createClass(Aside2, [{
          ...
          value: function _init(config) {
            var _this = this;
            var $2 = this._jQueryBS ? window.jQuery : null;
            ...
            if (!config.blocking) {
              ...
              if ($2) {
                $2(this.element).data("backdrop", false);
              }
            } else {
              if (config.backdrop) {
              ...
              if ($2) {
                $2(this.element).data("backdrop", true);
              }
            }
            ...
            if (!$2) return;
            $2(this.element).off("shown.bs.modal.autohide");
            if (config.autohide) {
              $2(this.element).on("shown.bs.modal.autohide", function() {
                setTimeout(function() {
                  _this.hide();
                }, config.autohide);
              });
          ...
          value: function _setPlacement() {
            var placement = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "center";
            var placementMap = {
              t: "aside-top",
              top: "aside-top",
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new Aside2(element, config);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              if (!data) {
                data = Aside2.getInstance(this, _config);
          ...
          value: function _HandleAside() {
            ...
            $2(".ace-aside.modal-nb").data("backdrop", false);
            var onBeforeShow = function onBeforeShow2(modal) {
              if (modal.classList.contains("modal-nb")) {
                if (document.querySelector(visibleModalSelector) === null) {
                  document.body.classList.add("modal-nb");
                }
              } else {
                ...
                if (blur !== null && window.CSS) {
                  if (window.CSS.supports("filter", "none")) {
                    ...
                    if (bodyContainer !== null) {
                      ...
                      $2(modal).one("hidden.bs.modal.blur", function() {
            ...
            var onAfterShow = function onAfterShow2(modal) {
              if (modal.classList.contains("modal-nb")) {
            ...
            var onAfterHide = function onAfterHide2(modal) {
              if (document.querySelector(visibleModalSelector) === null) document.body.style.paddingRight = "";
            ...
            $2(document).on("show.bs.modal", ".modal", function(e) {
        ...
        _createClass(Toaster2, [{
          ...
          value: (
            ...
            function add(config) {
              ...
              _config.delay = _config.delay > 30 ? _config.delay : _config.delay * 1e3;
          ...
          value: function _addToContainer(toast, _config) {
            var isNewElement = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
          ...
          value: function removeAll() {
            var placement = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
            var instant = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
          ...
          value: function hide(id) {
            ...
            var instant = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
          ...
          value: function _hideBySelector(selector) {
            ...
            window.jQuery(selector).each(function() {
              ...
              if (!instant && $toast.is(":visible")) {
                $toast.toast("hide").off("hidden.bs.toast.1").one("hidden.bs.toast.2", function() {
                  $toast.toast("dispose");
          ...
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              window.jQuery[NAME$6].addEl(this, config);
            });
          }
        }]);
        return Toaster2;
      ...
      var Card = /* @__PURE__ */ (function() {
        ...
        _createClass(Card2, [{
          ...
          value: function startLoading() {
            var loadingHtml = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '<i class="bs-card-loading-icon fa fa-spinner fa-spin fa-2x text-white"></i>';
          ...
          value: function close() {
            ...
            if (this.isFullscreen()) Util.remove(Util.next(this.element, ".card-expanded-placeholder"));
            var _closeComplete = function _closeComplete2() {
            ...
            if (Util.isReducedMotion()) _closeComplete();
              ...
              this.element.addEventListener("transitionend", function(e) {
                if (e.target !== _this.element) return;
                _closeComplete();
              });
            }
          }
          ...
          value: function toggle(type) {
            ...
            if (this._jQueryBS) {
              if (action === "hide") body.classList.add("show");
          ...
          value: function expand(_expand, animate) {
            ...
            animate = !(animate === false || Util.isReducedMotion());
            ...
            if ($expand) {
              ...
              if (animate) {
                ...
                var transitionFn = function transitionFn2(e) {
                  if (e.target !== _this3.element) return;
                  _this3.element.removeEventListener("transitionend", transitionFn2);
              ...
              if (animate) {
                ...
                var _transitionFn = function _transitionFn2(e) {
                  if (e.target !== _this3.element) return;
                  _this3.element.removeEventListener("transitionend", _transitionFn2);
                  _this3.element.classList.remove("card-expanding");
                  params.forEach(function(param) {
                    _this3.element.style[param] = "";
                  });
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new Card2(element, config);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
          value: function _jQueryInterface(config, value) {
            return this.each(function() {
              ...
              if (!data) {
                data = Card2.getInstance(this, _config);
      ...
      var ImagePreviewError = /* @__PURE__ */ (function(_Error) {
        _inherits(ImagePreviewError2, _Error);
        var _super = _createSuper(ImagePreviewError2);
        function ImagePreviewError2(message, code) {
          var _this;
          _classCallCheck(this, ImagePreviewError2);
          _this = _super.call(this, message);
          _this.code = code;
          return _this;
        }
        return ImagePreviewError2;
      })(/* @__PURE__ */ _wrapNativeSuper(Error));
      var FileInput = /* @__PURE__ */ (function() {
        function FileInput2(element, config) {
          var _this2 = this;
          _classCallCheck(this, FileInput2);
          ...
          this._hasFileList = "FileList" in window;
        ...
        _createClass(FileInput2, [{
          ...
          value: function showFileList($files, innerCall) {
            ...
            var _loop = function _loop2(i2) {
              var filename = "";
              var format = false;
              if (typeof files[i2] === "string") filename = files[i2];
              else if (_this4._hasFile && files[i2] instanceof window.File) filename = files[i2].name.trim();
              else if (files[i2] instanceof Object && Object.prototype.hasOwnProperty.call(files[i2], "name")) {
                filename = files[i2].name;
                if (Object.prototype.hasOwnProperty.call(files[i2], "type")) format = files[i2].type;
                if (!Object.prototype.hasOwnProperty.call(files[i2], "path")) files[i2].path = files[i2].name;
              ...
              var type = innerCall === true && _this4._hasFile && files[i2] instanceof window.File ? files[i2].type.trim() : "";
              var canPreview = _this4.settings.previewImage !== false && _this4._hasFileReader && _this4.settings.thumbnail && (type.length > 0 && type.match("image") || type.length === 0 && format === "image");
              if (canPreview) {
                try {
                  _this4._previewImage(files[i2], label).catch(function(result) {
          ...
          key: "startLoading",
          value: function startLoading() {
            var loadingHtml = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '<i class="overlay-content fa fa-spin fa-spinner text-white fa-2x"></i>';
          ...
          value: function _enableFileDrop() {
            ...
            EventHandler.on(dropbox, "drop", function(e) {
              ...
              if (!_this5._isMulti && tmpFileList.length > 1) {
                ...
                tmpFileList = tmpfiles;
              }
              tmpFileList = _this5._processFiles(tmpFileList, true);
              if (tmpFileList === false) return false;
              _this5.selectMethod = "drop";
              var fileArray = [];
          ...
          value: function _handleOnChange() {
            var tmpFileList = this.element.files || [this.element.value];
            tmpFileList = this._processFiles(tmpFileList, false);
            if (tmpFileList === false) return false;
            var fileArray = [];
            for (var f = 0; f < tmpFileList.length; f++) {
              fileArray.push(tmpFileList[f]);
          ...
          value: function _previewImage(file, label) {
            ...
            return new Promise(function(resolve, reject) {
              var icon = label.querySelector(".ace-file-icon");
              if (icon) Util.empty(icon);
              var getImage = function getImage2(src, $file) {
                var img = Util.prepend(icon, "<img style='display: none;' />");
              ...
              var imgLoaded = function imgLoaded2(img, $file) {
                ...
                if (_this6.settings.thumbnail === "fit") size = icon.parentNode.offsetWidth;
                else if (typeof size === "number") size = parseInt(Math.min(size, icon.parentNode.offsetWidth));
                var svg = /svg/.test($file.type);
                var thumb = !svg ? _this6._getThumbnail(img, size, $file.type) : false;
                if (thumb === null) {
                  Util.remove(img);
              ...
              var imgFailed = function imgFailed2(img) {
                Util.remove(img);
          ...
          value: function _checkFileList(files, dropped) {
            ...
            if (!(allowExt || denyExt || allowMime || denyMime || maxSize)) return true;
            var safeFiles = [];
            var errorList = {};
            for (var i = 0; i < files.length; i++) {
              var file = files[i];
            ...
            if (safeFiles.length === files.length) return files;
            var errorCount = {
              ext: 0,
              mime: 0,
              size: 0
          ...
          value: function _setAcceptAttr() {
            var ext = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
            var mime = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
            if (ext) {
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new FileInput2(element, config);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
          value: function _jQueryInterface(config, value) {
            ...
            var reteach = this.each(function() {
              ...
              if (!data) {
                data = FileInput2.getInstance(this, _config);
      ...
      var Wysiwyg = /* @__PURE__ */ (function() {
        function Wysiwyg2(element, config) {
          _classCallCheck(this, Wysiwyg2);
          this._element = element;
          this._config = this._getConfig(config);
          this.initEditor();
        }
        _createClass(Wysiwyg2, [{
          key: "initEditor",
          value: function initEditor() {
            ...
            else toolbar = $__default["default"](this._element).before(toolbarHtml).prev();
            ...
            var self2 = $__default["default"](this._element);
            var viewSource = false;
            toolbar.find("a[data-toggle=source]").on("click", function(e) {
              e.preventDefault();
              if (!viewSource) {
                $__default["default"]("<textarea />").css({
                  width: self2.outerWidth(),
                  height: self2.outerHeight()
                }).val(self2.html()).insertAfter(self2);
                self2.addClass("d-none");
                $__default["default"](this).addClass("active");
              } else {
                var textarea = self2.next();
                self2.html(textarea.val()).removeClass("d-none");
                textarea.remove();
          ...
          value: function _handleImages() {
            ...
            $__default["default"](this._element).on("click", "img", function(ev) {
              ...
              $__default["default"](document).on("click.popover-wysiwyg-image", function(ev2) {
                if (ev2.target === currentImg) return;
                if ($__default["default"](ev2.target).closest(".popover-wysiwyg-image").length > 0) {
                  return;
                }
            ...
            $__default["default"](document).on("click", ".popover-wysiwyg-image button.btn", function() {
              ...
              if (action === "align") $__default["default"](currentImg).attr("class", "float-" + value);
              else if (action === "remove") {
                $__default["default"](currentImg).popover("dispose").remove();
                currentImg = null;
              }
            });
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new Wysiwyg2(element, config);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              if (!data) {
                data = Wysiwyg2.getInstance(this, _config);
      ...
      var NavTabScroller = /* @__PURE__ */ (function() {
        function NavTabScroller2(element) {
          _classCallCheck(this, NavTabScroller2);
          this._element = element;
          this._firefox = "MozAppearance" in document.documentElement.style;
          this._init();
        }
        _createClass(NavTabScroller2, [{
          key: "_init",
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new NavTabScroller2(element);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              if (!data) {
                data = NavTabScroller2.getInstance(this);
        ...
        return NavTabScroller2;
      })();
      var NavLinkScroller = /* @__PURE__ */ (function() {
        function NavLinkScroller2(element) {
          _classCallCheck(this, NavLinkScroller2);
          this._element = element;
          this._firefox = "MozAppearance" in document.documentElement.style;
        }
        _createClass(NavLinkScroller2, [{
          key: "_scrollIntoView",
          value: (
            // scroll tab button elements into view when clicked
            function _scrollIntoView() {
              var smooth = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
              var li = this._element.parentNode;
              var nav = li.parentNode;
              var navClientWidth = nav.clientWidth;
              var navScrollWidth = nav.scrollWidth;
              if (navScrollWidth <= navClientWidth) return;
              var isRTL = Util.isRTL();
              var _scrollLeft;
              if (!isRTL) {
          ...
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              var data = $this.data(DATA_KEY$3);
              if (!data) {
                data = NavLinkScroller2.getInstance(this);
                $this.data(DATA_KEY$3, data);
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new NavLinkScroller2(element);
            return element[name];
          }
        }, {
          key: "scrollIntoView",
          value: function scrollIntoView(element) {
            var instance = NavLinkScroller2.getInstance(element);
            if (instance) instance._scrollIntoView();
          }
        }]);
        return NavLinkScroller2;
      })();
      if (typeof window.jQuery !== "undefined") {
        var $$3 = window.jQuery;
      ...
      var TabSwipe = /* @__PURE__ */ (function() {
        function TabSwipe2(element) {
          _classCallCheck(this, TabSwipe2);
          this._element = element;
          this._firefox = "MozAppearance" in document.documentElement.style;
          this._jQueryBS = typeof window.jQuery !== "undefined" && typeof window.bootstrap !== "undefined";
          this._init();
        }
        _createClass(TabSwipe2, [{
          key: "_init",
          value: function _init() {
            var _this = this;
          ...
          value: function _startPaneSwipe(ev, pane) {
            ...
            var paneTouchMoveCallback = function paneTouchMoveCallback2(ev2) {
              var touches2 = ev2.changedTouches[0];
              var newX = touches2.pageX;
              var newY = touches2.pageY;
              lastX = newX;
              if (swipeDir === 0) {
                var diffY = Math.abs(y1 - newY);
                var diffX = Math.abs(x1 - newX);
              ...
              if (newDir !== 0 && newDir !== curDir) {
                if (siblingPane !== null) _reset(siblingPane);
                curDir = newDir;
            ...
            var paneTouchEndCallback = function paneTouchEndCallback2(ev2) {
              var touches2 = ev2.changedTouches[0] || null;
              var x2 = touches2 !== null ? touches2.pageX : lastX;
              var t2 = Date.now();
            ...
            var _dismiss = function _dismiss2() {
            ...
            var _reset = function _reset2(sibling) {
              sibling.style.transform = "";
              sibling.style.transitionDuration = "0ms";
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new TabSwipe2(element);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              if (!data) {
                data = TabSwipe2.getInstance(this);
      ...
      var ScrollTop = /* @__PURE__ */ (function() {
        function ScrollTop2(element) {
          _classCallCheck(this, ScrollTop2);
          this._element = element;
          this._init();
        }
        _createClass(ScrollTop2, [{
          key: "_init",
          value: function _init() {
            var _this = this;
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new ScrollTop2(element);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
          value: function _jQueryInterface(config) {
            return this.each(function() {
              ...
              if (!data) {
                data = ScrollTop2.getInstance(this);
      ...
      var Sticky = /* @__PURE__ */ (function() {
        ...
        _createClass(Sticky2, [{
          ...
          value: function _init() {
            ...
            Sticky2._observer.observe(observedChild);
            setTimeout(function() {
          ...
          value: function _initObserver() {
            if (Sticky2._observer !== null) return;
            Sticky2._observer = new window.IntersectionObserver(function(_ref) {
              var _ref2 = _slicedToArray(_ref, 1), entry = _ref2[0];
              var isSticky = entry.intersectionRatio < 1 && entry.boundingClientRect.bottom < 0;
              var stickyNav = entry.target.parentElement;
          ...
          value: function getInstance(element) {
            ...
            if (typeof element[name] !== "undefined") return element[name];
            element[name] = new Sticky2(element);
            return element[name];
          }
        }, {
          key: "_jQueryInterface",
...
// src/shims/pages.ts
var import_meta = {};
var pageModules = import_meta.glob(
...
// src/shims/utils.ts
var import_meta2 = {};
var utilsModules = import_meta2.glob(
  "../@utils/**/*.{js,ts}",
  { eager: false }
  // важно — асинхронно
);
...
(async () => {
  ...
  await Promise.resolve().then(() => __toESM(require_ace()));
  await loadAllUtils();
  await loadAllPages();
})();

// src/app.ts
var import_all = require("@fortawesome/fontawesome-free/css/all.css");
